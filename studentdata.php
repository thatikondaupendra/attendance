...
$name=$year.$branch;
   ...
   echo "successfully modified the content in...".$name;
//  $name=$year.$branch;
//  echo $name;
//$s="DROP TABLE $name";
//$rs=mysqli_query($conn,$s);
...
$name=$year.$branch;
        ...
        $needs=mysqli_query($conn,"UPDATE $name SET phone_num = '$namval' WHERE id = '$id'");
        echo "successfully modified the content in...".$year.$branch;
//  $name=$year.$branch;
//  echo $name;
//$s="DROP TABLE $name";
//$rs=mysqli_query($conn,$s);
